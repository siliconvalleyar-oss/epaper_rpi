...
//   y=32:  "12:34:56"            FONT_16x32    (h=32)  → y=32..63
//   y=70:  ───────────────       linea horizontal
//   y=82:  "2026-07-24"          FONT_5x8      (h=8)   → y=82..89
//   y=100: "DOMINGO"             FONT_5x8      (h=8)   → y=100..107
//   y=120: "UP: 00:05:32"        FONT_5x8      (h=8)   → y=120..127
//
...
int main() {
    ...
    std::cout << "Fuente reloj: FONT_16x32_BIGNUM (16x32)" << std::endl;
    ...
    while (running) {
        ...
        display.drawCenteredString(32, formatTime(t), FONT_16x32_BIGNUM, true);

        int lineY2 = 68;
        display.drawLine(10, lineY2, 285, lineY2, true);

        display.drawCenteredString(82, formatDate(t), FONT_5x8, true);

        display.drawCenteredString(100, formatDay(t), FONT_7x8_THICK, true);

        display.drawCenteredString(120, formatUptime(uptime), FONT_5x8, true);
