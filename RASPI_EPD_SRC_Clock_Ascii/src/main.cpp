...
//   y=16:  ───────────────
//   y=18:  "12:34:56"            FONT_16x16_MEDNUM (h=16)  → y=18..33
//   y=38:  ───────────────
...
int main() {
    ...
    while (running) {
        ...
        display.drawCenteredString(layout.titleY, layout.title, FONT_5x8, true);

        display.drawLine(layout.lineX1, layout.line1Y, layout.lineX2, layout.line1Y, true);

        display.drawCenteredString(layout.timeY, formatTime(t), FONT_16x16_MEDNUM, true);

        display.drawLine(layout.lineX1, layout.line2Y, layout.lineX2, layout.line2Y, true);
        ...
        display.drawLine(layout.lineX1, layout.line3Y, layout.lineX2, layout.line3Y, true);
